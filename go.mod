module github.com/hamster-shared/hamster-provider
...
require (
	...
	github.com/compose-spec/compose-go v1.2.8 // indirect
	...
	github.com/moby/buildkit v0.10.1-0.20220510163842-844618f5060a // indirect
...
replace github.com/docker/compose/v2 v2.6.1 => ./core/modules/compose/compose
...
replace (
	...
	github.com/tonistiigi/fsutil => github.com/mohaijiang/fsutil v0.0.1
)
